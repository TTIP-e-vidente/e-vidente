...
flowchart TD
    ...
    D -->|Resume| G[" Last Save<br/>SaveManager"]
    ...
    J -->|continue| L[" Back to Menu<br/>GameSceneRouter"]
...
|  El mapa visual | `mapas/MapScene.gd` |  medio | Cómo se ve cada nivel, si está desbloqueado |
...
|  El catálogo de tracks (celiaquia, veganismo, etc) | `niveles/GameTrackCatalog.gd` |  medio | 4 tracks: define cuál es cuál |
