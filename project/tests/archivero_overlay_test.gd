...
func _run() -> void:
	...
	if archivero_scene != null:
		...
		var streak_badge: PanelContainer = archivero_instance.get_node("ProfileOverlayLayer/ProfileOverlay/SessionPanel/MarginContainer/ProfileContent/SummaryPanel/MarginContainer/SummaryContent/InfoColumn/StreakBadge")
		var streak_title_label: Label = archivero_instance.get_node("ProfileOverlayLayer/ProfileOverlay/SessionPanel/MarginContainer/ProfileContent/SummaryPanel/MarginContainer/SummaryContent/InfoColumn/StreakBadge/MarginContainer/ContentRow/TextColumn/TitleLabel")
		var streak_count_label: Label = archivero_instance.get_node("ProfileOverlayLayer/ProfileOverlay/SessionPanel/MarginContainer/ProfileContent/SummaryPanel/MarginContainer/SummaryContent/InfoColumn/StreakBadge/MarginContainer/ContentRow/TextColumn/CountLabel")
		var streak_today_label: Label = archivero_instance.get_node("ProfileOverlayLayer/ProfileOverlay/SessionPanel/MarginContainer/ProfileContent/SummaryPanel/MarginContainer/SummaryContent/InfoColumn/StreakBadge/MarginContainer/ContentRow/TextColumn/MetaRow/TodayChip/MarginContainer/TodayChipLabel")
		var streak_best_label: Label = archivero_instance.get_node("ProfileOverlayLayer/ProfileOverlay/SessionPanel/MarginContainer/ProfileContent/SummaryPanel/MarginContainer/SummaryContent/InfoColumn/StreakBadge/MarginContainer/ContentRow/TextColumn/MetaRow/BestChip/MarginContainer/BestChipLabel")
		...
		_assert(streak_badge != null, "Archivero deberia exponer un badge temporal para la racha")
		...
		_assert(streak_title_label.text.contains("Racha activa"), "El badge deberia indicar cuando la racha ya fue sostenida hoy")
		_assert(streak_count_label.text.contains("1 dia"), "El badge deberia mostrar la racha diaria actual")
		_assert(streak_today_label.text.contains("Hoy ok"), "El badge deberia indicar si hoy ya conto para la racha")
		_assert(streak_best_label.text.contains("Mejor 1 dia"), "El badge deberia mostrar la mejor racha historica")
