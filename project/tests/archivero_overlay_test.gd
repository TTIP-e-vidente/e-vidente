...
func _run() -> void:
	...
	var profile_result := SaveManager.update_local_profile(TEST_USERNAME, TEST_AGE, TEST_EMAIL, "")
	...
	if archivero_scene != null:
		...
		var username_label: Label = archivero_instance.get_node("ProfileOverlayLayer/ProfileOverlay/SessionPanel/MarginContainer/ProfileContent/SummaryPanel/MarginContainer/SummaryContent/UsernameLabel")
